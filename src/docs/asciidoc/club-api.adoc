...
include::{snippets}/club/getSchedule/http-request.adoc[]
===== Path Parameter

include::{snippets}/club/getSchedule/path-parameters.adoc[]

===== Request Header

include::{snippets}/club/getSchedule/request-headers.adoc[]

==== Response

include::{snippets}/club/getSchedule/http-response.adoc[]

===== Response Body
include::{snippets}/club/getSchedule/response-fields.adoc[]
:sectnums:
